...
CREATE INDEX IF NOT EXISTS idx_atoms_key ON atoms(key);
...
CREATE INDEX IF NOT EXISTS idx_properties_atom ON atom_properties(atom_id);
CREATE INDEX IF NOT EXISTS idx_properties_kind ON atom_properties(atom_id, kind);
CREATE INDEX IF NOT EXISTS idx_properties_source_ref ON atom_properties(source_ref) WHERE source_ref IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_relations_from ON atom_relations(from_id);
CREATE INDEX IF NOT EXISTS idx_relations_to ON atom_relations(to_id);
...
CREATE INDEX IF NOT EXISTS idx_traces_atom ON traces(atom_id);
...
CREATE INDEX IF NOT EXISTS idx_analysis_atoms_atom ON analysis_atoms(atom_id);
CREATE INDEX IF NOT EXISTS idx_analysis_atoms_analysis ON analysis_atoms(analysis_id);
